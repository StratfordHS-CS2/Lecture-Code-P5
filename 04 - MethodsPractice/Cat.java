public class Cat
{
    ...
    /**
     * The cat will sleep for a specified number of minutes. Anytime you
     * have a parameter sent to the method you must add a @param tag to 
     * the javadoc.
     * 
     * @param   minutes     How many minutes the cat should nap.
     */
    public static void takeANap( int minutes )
    {
        int time = minutes;
        System.out.println( "Zzzz... Sleeping for " + time + " minutes." );
    }
    ...
    public static void main( String[] args )
    {
        ...
        name();   // does nothing because it returns a string, doesn't print a string.
